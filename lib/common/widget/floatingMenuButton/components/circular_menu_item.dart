...
class CircularMenuItem extends StatelessWidget {
  /// if iconData and animatedIcon are passed, iconData will be ignored
  /// if iconData and icon are passed, icon will be ignored
  final Widget icon;
  ...
  /// if animatedIcon and iconData are passed, iconData will be ignored
  /// if iconData and icon are passed, icon will be ignored
