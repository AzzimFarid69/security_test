...
/// Referring to circular_menu package on pub.dev with custom changes -zira
class CircularMenu extends StatefulWidget {
  ...
  /// if toggleButtonAnimatedIconData and toggleButtonIconData are passed, toggleButtonIconData will be ignored
  /// if toggleButtonIconDataClose is not passed, static toggleButtonIconData will be used
  final AnimatedIconData toggleButtonAnimatedIconData;
  final IconData toggleButtonIconData;
  final IconData toggleButtonIconDataClose;
  ...
  CircularMenu({
    ...
    this.toggleButtonIconDataClose,
    this.key,
...
class CircularMenuState extends State<CircularMenu> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _animation = Tween(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(
          parent: _animationController, curve: widget.curve, reverseCurve: widget.reverseCurve),
    );
    ...
    return Positioned.fill(
      child: Align(
        ...
        child: CircularMenuItem(
          ...
          padding:
              (-_animation.value * widget.toggleButtonPadding * 0.5) + widget.toggleButtonPadding,
          onTap: () {
            ...
            if (widget.toggleButtonIconData != null && widget.toggleButtonIconDataClose != null) {
          ...
          animatedIcon: widget.toggleButtonIconData == null
              ...
              : widget.toggleButtonIconDataClose != null
